(function($) {
    $.fn.extend({
        ccvalidate: function(options) {
            ...
            var cards = new Array();
            cards[0] = { name: "tes", clength: [16], exp: /^[1-9]/ };
            cards[1] = { name: "mcd", clength: [16], exp: /^5[1-5]/ };
            cards[2] = { name: "vis", clength: [13, 16], exp: /^4/ };
            cards[3] = { name: "amx", clength: [15], exp: /^3(4|7)/ };
            cards[4] = { name: "dnr", clength: [14], exp: /^3[0,6,8]\d{12}/ };
            cards[5] = { name: "dis", clength: [16], exp: /^6011\d{4}\d{4}\d{4}/ };
